...
FROM (SELECT
  m.uuid AS id, m.version, m.name, m.created as created, m.revised as revised,
  abstract, m.stateid, m.doctype,l.url AS license, m.module_ident AS ident, m.submitter, m.submitlog, m.portal_type as type,
