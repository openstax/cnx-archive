...
application problems.</div>""",
    ...
    def test_export_epub(self):
        ...
        self.request.matchdict = {'ident_hash': ident_hash}
        self.request.matched_route = mock.Mock()
        self.request.matched_route.name = 'epub'

        from ..views import get_epub

        resp = get_epub(self.request)

        import cnxepub
        epub = cnxepub.EPUB.from_file(resp.app_iter.file)
        # It's enough to check that it's an epub and that the read
        # to an EPUB object has parsed the internal structure of the
        # epub, thus vetting it as a valid EPUB.
        self.assertTrue(isinstance(epub, cnxepub.EPUB))

    def test_export_epub_for_module(self):
        ident_hash = "24a2ed13-22a6-47d6-97a3-c8aa8d54ac6d@2"
    ...
    def test_export_epub_for_collection_context(self):
        ident_hash = "24a2ed13-22a6-47d6-97a3-c8aa8d54ac6d@2"
        page_ident_hash = "f3c9ab70-a916-4d8c-9256-42953287b4e9@3"
